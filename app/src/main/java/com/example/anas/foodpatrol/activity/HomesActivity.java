 ...
 */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_id = (customfonts.MyTextView) navHeader.findViewById(R.id.txt_id);
        txt_username = (customfonts.MyTextView) navHeader.findViewById(R.id.txt_username);
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.nav_about_us:
                        ...
                        startActivity(new Intent(HomesActivity.this, AboutUsActivity.class));
                        drawer.closeDrawers();
                        return true;
                    case R.id.nav_privacy_policy:
                        // launch new intent instead of loading fragment
                        startActivity(new Intent(HomesActivity.this, PrivacyPolicyActivity.class));
                        drawer.closeDrawers();
                        return true;
                    default:
                        navItemIndex = 0;
